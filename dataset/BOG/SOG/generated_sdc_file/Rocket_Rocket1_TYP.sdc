...
# Get the clock port (e.g., named "clock")
set clk_port [get_ports clock]

# Remove the clock port from the inputs list
set data_inputs [lsearch -all -inline -not -exact $inputs $clk_port]

set_input_delay -clock CLK_clock  -max 0.05  $data_inputs
